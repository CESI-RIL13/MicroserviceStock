...
<html>
    ...
    <body>
        ...
        <div id="show-famille" class="content scaffold-show" role="main">
            ...
            <f:display bean="famille" />
            <g:form resource="${this.famille}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.famille}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
